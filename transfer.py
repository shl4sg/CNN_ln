...
# (:math:`D_C`) and one for the style (:math:`D_S`).聽:math:`D_C`聽measures how different the content
# is between two images while聽:math:`D_S`聽measures how different the style is
...
# loss and then returns the layer鈥檚 input. The computed loss is saved as a
...
#
# PyTorch鈥檚 implementation of VGG is a module divided into two child
...
# Conv2d, ReLU鈥�) aligned in the right order of depth. We need to add our
...
# dynamicaly compute their gradients. The optimizer requires a 鈥渃losure鈥�
